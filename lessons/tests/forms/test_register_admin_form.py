...
class RegisterAdminFormTestCase(TestCase):
    """
    Contains the test cases for the admin registration form
    """
    ...
    def test_valid_admin_registration_form(self):
        form = RegisterAdminForm(data=self.form_input)
